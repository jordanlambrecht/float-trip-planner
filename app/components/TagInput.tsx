...
const TagInput = ({
  ...
  const hasExactMatch = predefinedTags.some(
  ...
  return (
    <div className={clsx('relative', className)}>
      <div
        className='min-h-11 p-2 border border-text-dm rounded-md focus-within:ring-1 focus-within:ring-pink-dark focus-within:border-pink-dark cursor-text'
        onClick={() => {
