...
const TripOptionHeader = ({ option }: TripOptionHeaderProps) => {
  ...
  return (
    <div className='px-2 py-3 text-center'>
      ...
      <div className='mt-1'>
        <h2 className='text-center text-3xl font-bold leading-none sm:text-4xl text-text  mb-0 pb-0'>
          {month}
        </h2>
        <h3 className='font-sans text-2xl font-medium leading-none sm:text-3xl text-text '>
          {dates}
        </h3>
        <h3 className='font-sans text-xl leading-none sm:text-2xl text-text '>
          {year}
        </h3>
      </div>
    </div>
